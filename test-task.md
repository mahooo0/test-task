...
- A data model designed to support the functional requirements **and to scale** — see the README requirements in [Deliverables](#deliverables)
...
1.  Code files (required): A github repo with your code and a README containing:
...
2.  Hosted URLs (required): deployed frontend and backend — we recommend Vercel for the frontend
